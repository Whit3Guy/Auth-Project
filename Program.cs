...
Console.WriteLine("string de cenexão");
...
{
    throw new Exception("As variaveis do Jwt est�o vazias");
}
...
// construir autentica��o jwt Bearer
...
// Uma autoriza��o para user comum e outra para admin, apenas admins podem ler listas de Usuarios e deletar usuarios.
